...
public class TripRecordFactory extends StifRecordFactory<TripRecord> {
  ...
  private static StifFieldDefinition[] fields = {
      new FieldDef(3 - 1, "record type", new TripFieldSetter() {
      ...
      new FieldDef(15 - 7, "origin time", new TripFieldSetter() {
        public void setField(TripRecord record) {
          record.setOriginTime(getIntegerSafe());
        }
      }),
      ...
      new FieldDef(31 - 23, "destination time", new TripFieldSetter() {
        public void setField(TripRecord record) {
          record.setDestinationTime(getIntegerSafe());
        }
      }),
      new FieldDef(35 - 31, "pick code", new TripFieldSetter() {
          public void setField(TripRecord record) {
              record.setPickCode(getStringData());
          }
      }),
      new FieldDef(41 - 35, "primary run number", new TripFieldSetter() {
          public void setField(TripRecord record) {
              record.setPrimaryRunNumber(getStringData());
            }
          }),
      new FieldDef(53 - 41, "path code", new TripFieldSetter() {
          public void setField(TripRecord record) {
              record.setPathCode(getStringData());
          }
      }),
      new FieldDef(59 - 53, "primary run route", new TripFieldSetter() {
        public void setField(TripRecord record) {
          record.setPrimaryRunRoute(getStringData());
        }
      }),
      new FieldDef(65 - 59, "midtrip relief run number", new TripFieldSetter() {
          public void setField(TripRecord record) {
              record.setMidtripReliefRunNumber(getStringData());
            }
          }),
      new FieldDef(71 - 65, "midtrip relief run route", new TripFieldSetter() {
        public void setField(TripRecord record) {
          record.setMidtripReliefRunRoute(getStringData());
        }
      }),
      ...
      new FieldDef(83 - 79, "midtrip relief location", new TripFieldSetter() {
          public void setField(TripRecord record) {
              record.setMidtripReliefLocation(getStringData());
          }
      }),
      new FieldDef(84 - 83, "bus type code", new TripFieldSetter() {
    	  public void setField(TripRecord record){
    		  record.setBusTypeCode(getStringData());
    	  }
      }),
      ...
      new FieldDef(90 - 89, "first trip in sequence",  new TripFieldSetter() {
        public void setField(TripRecord record) {
          record.setFirstTripInSequence(getStringData());
        }
      }),
      ...
      new FieldDef(161 - 155, "sign code route for this trip", new TripFieldSetter() {
            public void setField(TripRecord record) { record.setSignCodeRouteForThisTrip(getStringData()); }
          }),
      new FieldDef(162 - 161, "empty", null),
      new FieldDef(168 - 162, "previous trip operator run number", new TripFieldSetter() {
        public void setField(TripRecord record) {
          record.setPreviousTripOperatorRunNumber(getStringData());
        }
      }),
      new FieldDef(169 - 168, "empty", null),
      new FieldDef(175 - 169, "previous trip operator route", new TripFieldSetter() {
          public void setField(TripRecord record) {
          record.setPreviousTripOperatorRoute(getStringData());
          }
      }),
